...
const Footer = () => {
const link = "https://eggovich.github.io/tentabank/"
return (
    ...
    <footer>
        ...
        <ul className="list-inline">
            <li className="list-inline-item"><a href={link}>Hem</a></li>
            <li className="list-inline-item"><a to="/browse">Tentabank</a></li>
            <li className="list-inline-item"><a to={link+"upload"}>Ladda upp</a></li>
